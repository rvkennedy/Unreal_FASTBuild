    ...
    class FASTBuild : ActionExecutor
    {
        ...
        public override bool ExecuteActions(List<Action> Actions, bool bLogDetailedActionStats)
        {
            ...
            if (Actions.Count > 0)
            {
                ...
                string FASTBuildFilePath = Path.Combine(UnrealBuildTool.EngineDirectory + "/Intermediate", "fbuild.bff");
        ...
        private void WriteEnvironmentSetup()
        {
            ...
            if (VCEnv != null)
            {
                ...
                if (WindowsPlatform.GetDefaultCompiler() == WindowsCompiler.VisualStudio2017)
                {
        ...
        private bool ExecuteBffFile(string BffFilePath)
        {
            ...
            FBStartInfo.WorkingDirectory = Path.Combine(UnrealBuildTool.EngineDirectory.FullName, "Source");
